    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            ref={modalRef}
            className="game-modal bg-gray-900 rounded-2xl shadow-[0_0_50px_rgba(255,0,255,0.5)] border-4 border-pink-500 max-w-4xl w-full max-h-[90vh] overflow-hidden relative"
              ...
              <div className="modal-body p-6 space-y-6">
                ...
                {game.screenshots && (
                  ...
                  >
                    ...
                    <div className="screenshots-grid grid grid-cols-2 md:grid-cols-3 gap-4">
                      {game.screenshots.map((screenshot, index) => (
                        <motion.img
                          key={index}
                          src={screenshot}
                          alt={`Captura de pantalla ${index + 1} de ${game.title}`}
                          className="w-full h-32 object-cover rounded-lg border-2 border-gray-700 hover:border-pink-400 transition-colors cursor-pointer"
